...
app.doScript(function () {
  ...
  objDlg.add("button", [40, 230, 265, 290], "ファイルを選択し、配置を開始", {
    name: "ok"
  });
  objDlg.add("button", [100, 310, 200, 350], "キャンセル", {
    name: "cancel"
  });
  ...
  if (txtFile != "" && txtFile != null) {
    ...
    if (txtStr === "") {
      alert("空のテキストファイルが読み込まれました。処理を中断します。");
      fontObj.remove();
      exit();
    }
